...
let SimpleParseSmtpAdapter = (adapterOptions, b, c) => {
  ...
  let transporter = nodemailer.createTransport({
    ...
    tls: {
      rejectUnauthorized:
        adapterOptions.isTlsRejectUnauthorized !== undefined
          ? adapterOptions.isTlsRejectUnauthorized
          : true,
    },
  });
   ...
   * check module docs: https://github.com/forwardemail/email-templates
   *
  ...
  let renderTemplate = (template, data) => {
    ...
    let html = new Email({
      views: {
        options: {
          path: templateDir,
          extension: adapterOptions.extension || "handlebars",
        },
      },
    });

    return html.render(templateDir, data);
  };
